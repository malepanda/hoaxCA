...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li>
            ...
            <a href="<?php echo base_url(); ?>user/logout"><i class="fa fa-user"></i> Administrator Log out</a>
        </li>
    </ul>
...
>>>>>>> 1d9e011b2e6fa8e5f873f0650894a4d65b1610f2
            ...
            <li <?php if ($aktif=="barang") {?>class="active"<?php }?> >
                <a href="<?php echo base_url();?>admin/index.html"><i class="fa fa-fw fa-wrench"></i> Buat CSR</a>
            </li>
            ...
            <li <?php if ($aktif=="transaksi") {?>class="active"<?php }?>>
                <a href="<?php echo base_url();?>admin/viewCSR"><i class="fa fa-fw fa-desktop"></i> Lihat CSR</a>
            </li>
